...
\footnotesize
\item Note: All regressions control for student and peer background characteristics, and classroom fixed effects. Standard errors clustered at student level in parentheses. The dependent variable is peer-assigned score. *p<0.10, ** p<0.05, *** p<0.01.
\end{tablenotes}
\end{threeparttable}
}
\end{table}