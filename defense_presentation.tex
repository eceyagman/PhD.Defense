...
\date{[Date]} %TODO: fill in defense date

\titlegraphic{\includegraphics[width=0.4\textwidth]{figures/Logo.png}}
...
\begin{frame}{Three Chapters, One Setting, Progressive Depth}
\small
\begin{center}
\begin{tabular}{llll}
\toprule
...
\vspace{0.5cm}
%TODO: Insert thesis architecture funnel diagram
%\includegraphics[width=0.7\textwidth]{figures/thesis_funnel.png}
\textcolor{gray}{\textit{[Visual: Funnel diagram --- Ch.1 broad $\rightarrow$ Ch.2 focused $\rightarrow$ Ch.3 experimental test]}}
\end{frame}
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Chapter 1: Treatment Effects}
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Chapter 3: In-Group Bias \& Treatment}
