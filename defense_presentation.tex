...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% INTRODUCTION  (slides 1--10, title page unnumbered)
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% ---- Slide 3: The pedagogical program ----
...
% ---- Slide 6: Multi-rater assessment ----
...
% ---- Slide 8: Teacher training and mentoring ----
...
% ---- Slide 9: The study design ----
\begin{frame}{The study design: Clustered RCT}\label{slide:design}
\small
\textbf{Sample frame}
\begin{itemize}
    \item 40 secondary schools, 141 classrooms, 116 teachers, 2,450 students (ages 12--17)
    \item Recruitment: public channels, voluntary, targeted schools with underprivileged students (high complexity)
\end{itemize}
\vspace{0.4cm}
...
% ---- Slide 10: Three chapters at a glance ----
...
\begin{tikzpicture}[
  ...
  % ---- Header bands (full rounded top, square bottom) ----
...
% ---- Slide 13: Econometric specification ----
...
% ---- Slide 17: Ch.1 takeaway and bridge to Ch.2 ----
...
\vspace{0.3cm}
\begin{enumerate}
    \item \fadecolor{1}{\textbf{Male peers are gender-neutral:} $\beta_1$ is small/insignificant $\rightarrow$ males don't rate female students differently from male students}
    \vspace{0.2cm}
    \item \fadecolor{2}{\textbf{Female peers are strict toward males:} $\beta_2$ is negative and significant in all domains $\rightarrow$ female peers give lower scores when rating male students}
    \vspace{0.2cm}
    \item \fadecolor{3}{\textbf{Female-female premium:} $\beta_3$ is large and positive $\rightarrow$ when a female peer rates a female student, there is an additional +0.24 to +0.43 SD boost}
\end{enumerate}
